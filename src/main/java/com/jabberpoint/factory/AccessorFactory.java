 ...
 * - Single Responsibility Principle: Only responsible for creating accessor objects
 * - Open/Closed Principle: New accessor types can be added without modifying existing code
 * - Dependency Inversion Principle: Depends on the Accessor abstraction, not concrete implementations
 * - Interface Segregation Principle: Clients only need to work with the Accessor interface
 *
 * Factory for creating different types of accessors for presentations.
