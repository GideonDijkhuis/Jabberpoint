...
/**
 * <p>main.java.com.jabberpoint.command.NextSlideCommand implements the main.java.com.jabberpoint.command.Command
 * interface to navigate to the next slide</p>
 *
 * @author Bram Huiskes
 * @version 1.0
 */
