 ...
 * - Single Responsibility Principle: Only responsible for saving a presentation
...
public class SaveCommand implements Command
{
    ...
    /**
     * Executes the command to save a presentation.
     * Shows a file chooser dialog and saves to the selected file.
     */
    @Override
    public void execute()
    {
