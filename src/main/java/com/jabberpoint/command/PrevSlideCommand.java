...
/**
 * <p>main.java.com.jabberpoint.command.PrevSlideCommand implements the main.java.com.jabberpoint.command.Command
 * interface to navigate to the previous slide</p>
 *
 * @author Bram Huiskes
 * @version 1.0
 */
