...
/**
 * SOLID Principles Applied: - Single Responsibility Principle: Each accessor handles one type of data source -
 * Open/Closed Principle: New accessors can be added without modifying existing ones - Liskov Substitution Principle:
 * All accessors can be used interchangeably - Dependency Inversion Principle: High-level modules depend on this
 * abstraction
 *
