 ...
 * - Single Responsibility Principle: Only responsible for managing observers and notifications
 * - Open/Closed Principle: Can be extended with new notification behaviors without modification
 * - Interface Segregation Principle: Defines only methods necessary for subject behavior
 * - Dependency Inversion Principle: High-level modules depend on this abstraction
 * - Liskov Substitution Principle: All implementations should be substitutable without affecting behavior
 *
