 ...
 * - Single Responsibility Principle: Base class for slide items with common behavior
 * - Open/Closed Principle: Can be extended with new item types without modification
 * - Liskov Substitution Principle: All derived classes can be used interchangeably
 * - Interface Segregation Principle: Implements only necessary Subject methods
 * - Dependency Inversion Principle: Depends on abstractions (Subject interface)
 *
