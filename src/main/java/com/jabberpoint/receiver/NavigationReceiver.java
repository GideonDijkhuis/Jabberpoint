 ...
 * 
 * SOLID Principles:
 * - Single Responsibility Principle: Handles only navigation-related commands for the presentation.
 * - Open/Closed Principle: New navigation commands can be added without modifying existing ones.
 * - Liskov Substitution Principle: Properly implements the Receiver interface.
 * - Interface Segregation Principle: Implements the Receiver interface with methods relevant to navigation.
